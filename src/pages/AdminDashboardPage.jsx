    ...
    const fetchData = async () => {
      try {
        ...
        dailyRes.data.forEach((row) => {
          if (!grouped[row.day]) {
            grouped[row.day] = { day: row.day }
          }
          grouped[row.day][row.supplier_name] = row.total
    ...
    <div className="min-h-screen bg-concrete">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="bg-white border border-charcoal/10 rounded-sm p-6">
          <h2 className="font-medium text-charcoal mb-4">Продажи по дням</h2>
          ...
          {chartData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={350}>
              <LineChart data={chartData}>
                ...
                <XAxis dataKey="day" stroke="#1E1C1A99" />
